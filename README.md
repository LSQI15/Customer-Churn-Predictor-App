...
- [Running the app](#running-the-app)
  ...
  * [2. Download data from Kaggle / S3 bucket](#2-Download-data-from-Kaggle-or-S3-bucket)
    + [Option 1: Kaggle](#Kaggle)
    + [Option 2: S3 bucket](#S3-bucket)
...
### 2. Download data from Kaggle or S3 bucket
